...
const Navbar = () => {
    ...
    return (
        <nav className="flex flex-between w-full pt-4 justify-between px-20 mt-10">
            ...
            <div className="sm:flex hidden">
                {session?.user ? (
                    ...
                    <div className="flex flex-between gap-4 md:gap-4">
                        <Link href="/pages/register" className="mx-4 bg-white rounded-full bg-transparent py-2.5 px-5 text-black transition-all hover:bg-black hover:text-white text-center text-sm font-inter flex items-center justify-center">
                            Register
                        </Link>
                        <Link href="/pages/login" className="mr-4 rounded-full bg-blue-500 py-2.5 px-5 text-white transition-all hover:bg-white hover:text-black text-center text-sm font-inter flex items-center justify-center">
                            Sign In
                        </Link>
                    </div>
                )}
